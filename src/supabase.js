...
export const rowToKbCard = r => ({ id: r.id, title: r.title, body: r.body, region: r.region, country: r.country || r.region, section: r.section || "general", owner: r.owner, status: r.status, author: r.author, updatedAt: r.updated_at });
export const rowToKbRevision = r => ({ id: r.id, cardId: r.card_id, title: r.title, body: r.body, authorId: r.author_id, authorName: r.author_name, note: r.note, status: r.status, createdAt: r.created_at, decidedAt: r.decided_at, decidedBy: r.decided_by });
